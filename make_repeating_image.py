...
big_repeated_image = np.tile(chunk, reps=(vertical_repeat, horizontal_repeat, 1))
color_converted_image = cv2.cvtColor(np.float32(big_repeated_image), cv2.COLOR_RGB2BGR)
